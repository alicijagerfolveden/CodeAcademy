...
console.log(data.filter((v) => v.gender == "Male").length);

const personsWithNewerCars = data
  .filter((v) => v.car_year >= 2000)
  .map((v) => v.id);

console.log(personsWithNewerCars);

const slimPeople = data
  .filter((v) => v.shirt_size === "S" || v.shirt_size === "XS")
